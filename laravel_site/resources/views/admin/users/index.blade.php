											...
											<tr>
												...
												<td class="">
													<div class="d-flex align-items-center">
														<a href="{{ url('/admin/users/edit/'.$user->id) }}" class="me-3"><img src="{{ asset('assets/images/old_img/icon-eye.svg') }}" alt=""></a>
														<a role="button" onclick="return confirmBox('Delete items', 'Are you sure you want to delete the selected items?', 'itemTask', ['{{ $user->id }}', 'delete'])"><img src="{{ asset('assets/images/old_img/icon-trash.svg') }}"" alt=""></a>
													</div>
												</td>
											</tr>
